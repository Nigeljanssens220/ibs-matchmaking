...
const Dashboard: NextPage = () => {
    return (
        ...
        //                                 </svg>
        //                             </span>
        //                             <span className="mx-2 text-md ">Home</span>
        //                         </a>
        //                         <a
        ...
        //                             />
        //                         </a>
        //                         <button className="flex items-center text-white text-md">
        //                             Charlie R
        //                             <svg
        //                                 width="20"
        //                                 height="20"
        ...
        //                                         </p>
        //                                     </div>
        //                                     <div className="border-b border-gray-200 mt-6 md:mt-0 text-white font-bold text-xl">
        //                                         $44,453.39
        ...
        //                         <div className="w-1/2">
        //                             <div className="shadow-lg px-4 py-6 w-full bg-gray-700 relative">
